...
function UploadImage({uploadImage}) {
    ...
    return (
        <div className="w-[90%] h-[400px] z-30 flex flex-col  items-center bg-white border-[2px] rounded-xl  sm:w-[450px]">
            <h1 className="capitalize text-[1.5rem] text-center font-bold p-3 border-b-[1px] w-[100%] border-b-gray-400">create new post</h1>
            <div className="flex flex-col justify-center items-center my-auto gap-4">
                ...
                <h1 className="capitalize text-[1.6rem]">drag photo here</h1>
                <label htmlFor="file" className="bg-[#0095F6] cursor-pointer rounded-lg text-white text-[1.3rem] p-4 font-bold hover:bg-[#61aee2]">upload photo</label>
